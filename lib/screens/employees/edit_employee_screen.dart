...
class _EditEmployeeScreenState extends State<EditEmployeeScreen> with SingleTickerProviderStateMixin {
  ...
  Widget _buildDepartmentField(BuildContext context) {
    final localizations = AppLocalizations.of(context);

    // Extract department info from the employee data
    String departmentName = 'N/A';
    String departmentKey = 'N/A';

    if (widget.employeeData.containsKey('attributes') &&
        widget.employeeData['attributes'] != null &&
        widget.employeeData['attributes']['department'] != null) {
      departmentName = widget.employeeData['attributes']['department']['name'] ?? 'N/A';
      departmentKey = widget.employeeData['attributes']['department']['key']?.toString() ?? 'N/A';
    } else if (widget.employeeData.containsKey('department')) {
      departmentName = widget.employeeData['department'];
    }
